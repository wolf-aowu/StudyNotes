...
namespace Wanderer.EmojiText
{
    public class CreateSpriteAsset : EditorWindow
    {
        ...
        public static float screenRate = 0.625f;
        ...
        private void OnGUI()
        {
            if (_sourceTex != null)
            {
                ...
                //纹理渲染--------------
                var scrollWidth = screenRate * Screen.width > _sourceTex.width + 50? _sourceTex.width + 50 : screenRate * Screen.width;
                _texScrollView = GUILayout.BeginScrollView(_texScrollView, "", GUILayout.Width(scrollWidth));
            ...
            if (_sourceTex && _spriteAsset)
            {
                ...
                if (_spriteAsset.Row > 0)
                {
                    ...
                    for (int i = 0; i < max; i++)
                    {
                        ...
                        float endx = screenRate * Screen.width - 15.0f;
                ...
                if (_spriteAsset.Column > 0)
                {
                    ...
                    float scrollViewWidth = screenRate * Screen.width;
